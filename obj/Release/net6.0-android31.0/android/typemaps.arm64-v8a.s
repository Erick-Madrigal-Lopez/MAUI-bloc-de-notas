...
map_modules:
	...
	.byte	0x21, 0x89, 0xdd, 0xd6, 0xcb, 0x50, 0x4, 0x4e, 0xab, 0x4b, 0x64, 0x83, 0x29, 0xbb, 0x4b, 0xee	// module_uuid: d6dd8921-50cb-4e04-ab4b-648329bb4bee
	...
	.byte	0x60, 0x6f, 0x6e, 0x77, 0xfb, 0xff, 0x55, 0x4f, 0x9a, 0xd, 0x22, 0xc4, 0xb6, 0x65, 0x13, 0x4a	// module_uuid: 776e6f60-fffb-4f55-9a0d-22c4b665134a
	...
	.byte	0xcb, 0x9b, 0x5, 0x12, 0xa7, 0xfb, 0xcb, 0x4a, 0xbd, 0x10, 0x75, 0xcd, 0x51, 0xe8, 0x63, 0x87	// module_uuid: 12059bcb-fba7-4acb-bd10-75cd51e86387
	.word	0x2	// entry_count
	.word	0x0	// duplicate_count
	.xword	.L.module26_managed_to_java	// map
	.xword	0	// duplicate_map
	.xword	map_aname.26	// assembly_name: bloc-de-notas-app
	.xword	0x0	// image
	.word	0x0	// java_name_width
	.zero	4
	.xword	0x0	// java_map
...
map_java:
	...
	.word	0x200000c	// type_token_id
	.ascii	"crc64c5e5fd786674cd91/MainActivity"	// java_name
	.zero	69	// byteCount == 34; fixedWidth == 103; returned size == 103
	.zero	1

	.word	0x1a	// module_index
	.word	0x200000d	// type_token_id
	.ascii	"crc64c5e5fd786674cd91/MainApplication"	// java_name
	.zero	66	// byteCount == 37; fixedWidth == 103; returned size == 103
	.zero	1
